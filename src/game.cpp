...
void game::particle_groups_update(game::ParticleGroup &g_one, game::ParticleGroup &g_two, float gravity,
...
void game::particle_groups_apply_interactivity(game::ParticleGroups &groups,
                                               const game::InteractivityMatrix &interactivity, const Config &config)
{
